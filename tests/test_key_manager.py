...
Tests for key_manager read-only behavior. Keys are generated by the init
container before the backend starts; the backend only loads them from disk.
...
def test_init_licensing_keys_loads_existing_keypair(tmp_path):
    """init_licensing_keys loads valid Ed25519 key files without error."""
