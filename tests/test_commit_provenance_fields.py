...
from mantle.services.collection_service import record_collection_commit
...
@patch("mantle.services.collection_service.db_create_commit", autospec=True)
@patch("mantle.services.collection_service.db_create_commit_items", autospec=True, return_value=[])
