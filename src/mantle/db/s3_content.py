...
The client is S3-generic and brand-neutral, with no coupling to any one vendor: any S3-compatible
endpoint can serve this tier.
"""
...
class S3ContentStore(ContentStore):
    ...
    (`stats["cdn_fallback"]`), so "the CDN serves nothing" is a visible fact, not a latency
    mystery."""
