...
class TestWorkspaceCrud:
    ...
    def test_create_workspace_artifact_grants_owner_directly(self):
        ...
        db = MagicMock()
        with (
            patch("services.workspace_service.get_workspace"),
            patch("services.workspace_service.arango.create_artifact"),
            patch("services.workspace_service.arango.add_artifact_to_collection"),
            patch("services.workspace_service._link_to_target_collections"),
            patch("services.workspace_service._emit_event"),
            patch("services.workspace_service.arango.upsert_user_collection_grant") as grant,
        ):
